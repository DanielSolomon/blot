...
def test_quarter(posnum1: int, posnum2: int, negnum1: int, negnum2: int) -> None:
    ...
    assert q1.quarter == pyshart.graph.Point.QUARTER1
    assert q2.quarter == pyshart.graph.Point.QUARTER2
    assert q3.quarter == pyshart.graph.Point.QUARTER3
    assert q4.quarter == pyshart.graph.Point.QUARTER4
